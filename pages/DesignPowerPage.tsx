    ...
    <div className="bg-brand-offwhite min-h-screen flex flex-col font-sans text-brand-navy">
      ...
      <main className="flex-grow pt-32">
        <div className="container mx-auto px-8">
          ...
          {/* 1. HERO: The Hook */}
          <AnimatedSection>
            <header className="py-24 md:py-40 max-w-6xl">
              ...
              <h1 className="text-8xl md:text-[12vw] font-black uppercase tracking-tight leading-[0.9] mt-0">
                Make It <br/>
                <span className="text-transparent stroke-text-purple italic">Real.</span>
              </h1>
          ...
          <section className="py-24 border-t-2 border-brand-navy grid grid-cols-1 lg:grid-cols-2 gap-16">
             ...
             <div className="font-body text-xl leading-relaxed space-y-8">
                <p>
                          ...
                          <div className="border border-brand-navy/10 bg-white p-8 md:p-12 hover:border-brand-purple transition-all duration-500 group h-full flex flex-col justify-between">
                              <div>
                                  <div className="flex justify-between items-start mb-8">
                                      <div>
                                          <h3 className="text-4xl font-black uppercase italic group-hover:text-brand-purple transition-colors">{tier.name}</h3>
                                          <span className="font-mono text-xs uppercase tracking-widest text-brand-navy/40 mt-2 block">{tier.subtitle}</span>
                                      </div>
                                      <span className="font-mono text-xs border border-brand-navy/20 px-2 py-1 rounded-full">{tier.timeline}</span>
                                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  ...
                  <div className="lg:col-span-8 grid grid-cols-1 gap-12">
                      <div className="flex flex-col md:flex-row gap-8 items-start border-b border-brand-navy/5 pb-8">
                          ...
                          <div>
                              <h4 className="font-bold text-2xl uppercase mb-2">The Download</h4>
                      ...
                      <div className="flex flex-col md:flex-row gap-8 items-start border-b border-brand-navy/5 pb-8">
                          ...
                          <div>
                              <h4 className="font-bold text-2xl uppercase mb-2">The Messy Art Work</h4>
                      ...
                      <div className="flex flex-col md:flex-row gap-8 items-start border-b border-brand-navy/5 pb-8">
                          ...
                          <div>
                              <h4 className="font-bold text-2xl uppercase mb-2">The Build</h4>
